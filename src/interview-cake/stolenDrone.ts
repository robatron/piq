...
https://www.interviewcake.com/question/javascript/find-unique-int-among-duplicates?course=fc1&section=bit-manipulation
*/

export const findUniqueDeliveryId = (dIDs: number[]): number =>
    dIDs.reduce((uniqueID, dID) => uniqueID ^ dID, 0);
